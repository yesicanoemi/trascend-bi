    ...
    public class ConsultarGastoPresenter
    {
        ...
        public void BuscarInformacion()
        {
            ...
            if (_vista.TipoConsulta.SelectedIndex == 0) // La Seleccion fue por Propuesta
            {
                ...
                // QUITAR LUEGO DE SOLUCIONAR
                gastoAux = new Core.LogicaNegocio.Entidades.Gasto();
                gastoAux.Codigo = 1;
                gastoAux.Estado = "Proceso";
                gastoAux.IdVersion = 1;
                listaGasto.Add(gastoAux);
