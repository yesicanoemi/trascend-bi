<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPageHeader.master" AutoEventWireup="true" CodeFile="ModificarGastos.aspx.cs" Inherits="Paginas_Gastos_ModificarGastos" %>
			...
			<div class="sub-content"> 
                <div class="features_overview"> 
                    <div class="features_overview_right"> 
                        ...
                        <p class="large">Busqueda del Gasto a Modificar</p>
                        <form id="form1" runat="server">
                            <table>
		                        ...
		                        <tr>
		                            ...
		                            <td align="center"><asp:TextBox ID="uxFechaGasto" runat="server" Enabled="false"></asp:TextBox>
		                        ...
		                        <tr>
			                        <td colspan="2">
			                            <asp:GridView ID="uxConsultaGasto" runat="server" AllowPaging="True" DataSourceID="uxObjectConsultaGasto"
                                                        ...
                                                        Width="137%" Font-Names="Verdana" Font-Size="X-Small" onselectedindexchanged="uxConsultaGasto_SelectedIndexChanged">
