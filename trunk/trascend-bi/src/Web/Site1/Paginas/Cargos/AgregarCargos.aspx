                        ...
                        <p class="large">
                            <table style="width: 100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="uxNombre" runat="server"></asp:TextBox><asp:Label CssClass="campos" runat="server">*</asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="uxDescripcion" runat="server"></asp:TextBox><asp:Label ID="Label1" CssClass="campos" runat="server">*</asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="uxSueldoMinimo" runat="server" AutoPostBack="true"
                                            OnTextChanged="uxSueldoMinimo_TextChanged"></asp:TextBox><asp:Label ID="Label2" CssClass="campos" runat="server">*</asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="uxSueldoMaximo" runat="server" AutoPostBack="true"
                                            OnTextChanged="uxSueldoMaximo_TextChanged"></asp:TextBox><asp:Label ID="Label3" CssClass="campos" runat="server">*</asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:Image ID="uxImgFechaNac" runat="server" ImageUrl="~/Images/calendario.png" /><asp:Label CssClass="campos" ID="Label4" runat="server">*</asp:Label>
                                    </td>
