...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
 ...
 <li><a href="ReportesEquipo9b.aspx" >Total de Propuestas Emitidas<span></span></a></li>
    ...
    <div class="features_overview"> 
        ...
        <asp:GridView ID="uxFacturasPorCobrar" runat="server" 
            onselectedindexchanged="uxFacturasPorCobrar_SelectedIndexChanged" DataSourceID="uxObjectReporte8c">
        </asp:GridView>
        <br />
        <br />
        <br />
		...
		<pp:objectcontainerdatasource runat="server" ID="uxObjectReporte8c" DataObjectTypeName="Core.LogicaNegocio.Entidades.Factura" /> 
