...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
  ...
  <li><a href="EliminarFacturas.aspx" >Eliminar<span></span></a></li> 
          ...
          <div class="features_overview_right"> 
            ...
            <asp:MultiView ID="MultiViewPropuesta" runat="server" ActiveViewIndex="0">
                            ...
                            <form runat="server">
                                <table>
                                    <tr>
                                        ...
                                        <td> <asp:Button ID="uxBuscarTitulo_Click" runat="server" Text="Buscar" 
                                                onclick="uxBuscarTitulo_Click_Click" /></td>
